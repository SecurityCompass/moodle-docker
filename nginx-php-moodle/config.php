...
$CFG->dbhost    = getenv('PGSQL_HOSTNAME');     // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('PGSQL_DATABASE');     // database name, eg moodle
$CFG->dbuser    = getenv('PGSQL_USER');         // your database username
$CFG->dbpass    = getenv('PGSQL_PASSWORD');     // your database password
...
$CFG->dboptions = array(
    ...
    'dbport'    => getenv('PGSQL_PORT'),    // the TCP port number to use when connecting
